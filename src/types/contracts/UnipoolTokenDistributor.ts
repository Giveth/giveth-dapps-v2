...
export interface UnipoolTokenDistributorInterface extends utils.Interface {
  functions: {
...
export interface UnipoolTokenDistributor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UnipoolTokenDistributorInterface;
