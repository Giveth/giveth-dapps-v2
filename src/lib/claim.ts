...
export const fetchAirDropClaimData = async (address: string): Promise<ClaimData | undefined> => {
...
export const claimReward = async (
  ...
  const tokenDistro = new Contract(tokenDistroAddress, TOKEN_DISTRO_ABI, signer.connectUnchecked())
