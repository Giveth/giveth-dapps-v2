...
export const getGasPreference = (networkConfig: BasicNetworkConfig): GasPreference => {
  const selectedWallet = window.localStorage.getItem('selectedWallet')
  // MetaMask works with gas preference cofnig
  if (selectedWallet === EWallets.METAMASK) return networkConfig.gasPreference || {}
...
const noImgColors = [brandColors.cyan[500], brandColors.mustard[500], brandColors.giv[500]]
