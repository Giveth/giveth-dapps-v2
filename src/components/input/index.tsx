...
export const WalletAddressInputWithButton: FC<IWalletAddressInputWithButtonProps> = ({
  ...
  return (
    <InputContainer>
      <Input placeholder={placeholder} value={value} onChange={onValueChange} disabled={disabled} />
...
export const InputWithUnit: FC<IInputWithUnitProps> = ({
  ...
  return (
    <InputContainer>
      <BaseInput type={type} placeholder={placeholder} value={value} onUserInput={onChange} />
      <Unit>{unit}</Unit>
    </InputContainer>
  )
}
