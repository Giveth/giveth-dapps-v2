  ...
  return (
    <WalletMenuContainer isMounted={isMounted} theme={theme}>
      ...
      <Subtitle>
        ...
        {chainId && (
          <StyledButton onClick={() => switchNetworkHandler(chainId)}>Switch network</StyledButton>
        )}
      </Subtitle>
      <Menus>
...
const MenuItem = styled.a`
  ...
  cursor: pointer;
  color: ${props =>
    props.theme === ETheme.Dark ? neutralColors.gray[100] : neutralColors.gray[800]};
  border-top: 2px solid
    ${props => (props.theme === ETheme.Dark ? brandColors.giv[300] : neutralColors.gray[300])};
  &:hover {
    background-color: ${props =>
      props.theme === ETheme.Dark ? brandColors.giv[700] : neutralColors.gray[200]};
  }
`
