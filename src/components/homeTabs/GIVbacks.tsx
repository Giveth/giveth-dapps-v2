...
import { Container, IconExternalLink, IconGIVBack, P, brandColors } from '@giveth/ui-design-system'
import {
...
export const TabGIVbacksTop = () => {
  ...
  return (
    <>
          ...
          <Row justifyContent='space-between'>
            <Left>
              ...
              <GBSubtitle size='medium'>
                GIVbacks rewards donors to verified projects with GIV, super-charging Giveth as a
            ...
            <Right>
              <GIVbackRewardCard
                ...
                subButtonLabel={
                  balances?.givbackLiquidPart?.isZero() ? "Why don't I have GIVbacks?" : undefined
                }
                subButtonCb={() => {
      ...
      {showGivBackExplain && (
        <GIVBackExplainModal showModal={showGivBackExplain} setShowModal={setShowGivBackExplain} />
      )}
    </>
  )
}
...
export const TabGIVbacksBottom = () => {
  ...
  useEffect(() => {
    if (tokenDistroHelper) {
      ...
      _rounStartTime.setDate(tokenDistroHelper.startTime.getDate() + (_round - 1) * 14)
    ...
    <GIVbacksBottomContainer>
      <Container>
        <Row wrap={1} justifyContent='space-between'>
          ...
          >
            When you donate to verified projects you qualify to receive GIV tokens. Through
            GIVbacks, GIV empowers donors with governance rights via the GIVgarden.
          </GbDataBlock>
          <GbDataBlock
          ...
          >
            Great projects make the GIVeconomy thrive! As a project owner, when you get your project
            verified, your donors become eligible to receive GIVbacks.
          </GbDataBlock>
        </Row>
        <GIVBackCard>
          <Row justifyContent='space-between' alignItems='center'>
            <RoundSection>
              ...
              <RoundInfo>
                <RoundInfoRow justifyContent='space-between'>
                  <P>Start Date</P>
                  <P>{tokenDistroHelper ? formatDate(roundStartime) : '-'}</P>
                </RoundInfoRow>
                <RoundInfoRow justifyContent='space-between'>
                  <P>End Date</P>
                  <P>{tokenDistroHelper ? formatDate(roundEndTime) : '-'}</P>
                </RoundInfoRow>
                <RoundInfoTallRow justifyContent='space-between' alignItems='center'>
                ...
                <RoundButton
                  ...
                  buttonType='primary'
                  onClick={() => {
                    window.open('https://giveth.io/projects', '_blank')
                  }}
                />
              </RoundInfo>
            </RoundSection>
            <InfoSection>
              ...
              <InfoTitle weight={700}>When you give you get GIV back!</InfoTitle>
              <InfoDesc>
                Each GIVbacks round lasts two weeks. After the End Date, the GIV Allocated to that
                round is distributed to Givers who donated to verified projects during the round.
                Projects must apply for verification at least 1 week prior to the Start Date in
                order to be included in the round.
              </InfoDesc>
              <InfoReadMore target='_blank' href='https://docs.giveth.io/giveconomy/givbacks'>
                <span>Read More </span>
                <IconExternalLink size={16} color={brandColors.cyan[500]} />
              </InfoReadMore>
            </InfoSection>
          </Row>
        </GIVBackCard>
