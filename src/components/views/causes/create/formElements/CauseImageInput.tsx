...
const ImageSearch = dynamic(
	() => import('@/components/views/create/imageInput/ImageSearch'),
	{
		ssr: false,
	},
);
...
const CauseImageInput: FC<ImageInputProps> = ({
	setIsLoading,
	...
	return (
		<div
			onMouseEnter={() =>
				setActiveCauseSection(ECreateCauseSections.image)
			}
		>
			<H5>
				{formatMessage({
...
export default CauseImageInput;
