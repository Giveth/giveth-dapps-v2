...
import { Box } from '@/components/views/projects/MiddleBanners/common.sc';

export const CausesMiddleGivethVaultBanner = () => {
...
export default CausesMiddleGivethVaultBanner;
