...
import { H1, Lead, brandColors, P, Button, neutralColors, D3 } from '@giveth/ui-design-system'
  ...
  return (
    <>
      <Upper>
        ...
        <DotMustard />
        <TeamImageWrapper>
          <img width='100%' src='/images/giveth-team.jpg' alt='giveth team' />
        </TeamImageWrapper>
...
const EndPurpleArc = styled(Arc)`
  border-width: 40px;
  border-color: ${brandColors.giv[600]} ${brandColors.giv[600]} transparent transparent;
  bottom: 0;
  left: -180px;
  width: 260px;
  height: 260px;
