...
export const CausePublicActions = () => {
	...
	const { causeData, isActive } = useCauseContext();
	const project = causeData!;
	...
	return (
		<CausePublicActionsWrapper gap='16px'>
			{alreadyDonated && (
		...
		</CausePublicActionsWrapper>
	);
};

const CausePublicActionsWrapper = styled(Flex)`
	flex-direction: row;
