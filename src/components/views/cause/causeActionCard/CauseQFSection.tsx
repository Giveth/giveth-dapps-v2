...
interface CauseIQFSectionProps {
	causeData?: ICause;
}

const CauseQFSection: FC<CauseIQFSectionProps> = ({ causeData }) => {
			...
			sumDonationValueUsdForActiveQfRound !== 0 ? (
				<DonateInfo>
					...
					<Description>
						...
						<Caption $medium>
							{causeData?.countUniqueDonorsForActiveQfRound}
						</Caption>
						{formatMessage(
							{
							...
							{
								count: causeData?.countUniqueDonorsForActiveQfRound,
							},
						)}
						{' ' +
							formatMessage({
