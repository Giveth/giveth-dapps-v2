...
export const HarvestModal: FC<IHarvesModalProps> = ({ showModal, setShowModal }) => {
    ...
    >
      {state === States.Harvest && (
        <HarvestModalContainer>
          ...
          <HelpRow alignItems='center' justifyContent='center' gap='8px'>
            <Caption>Your additional GIVstream flowrate</Caption>
            <IconHelp size={16} color={brandColors.deep[100]} />
          </HelpRow>
          <RateRow alignItems='center' justifyContent='center' gap='4px'>
            <IconGIVStream size={24} />
            <GIVRate>{9.588}</GIVRate>
            <Lead>GIV/week</Lead>
          </RateRow>
          <HarvestButton label='HARVEST' size='medium' buttonType='primary' />
          <CancelButton
            label='CANCEL'
            size='medium'
            buttonType='texty'
      ...
      {state === States.Waiting && (
        <WitingModalContainer>
          ...
          <WaitinMessage weight={700}>Please confirm transaction in your wallet</WaitinMessage>
          <CancelButton
            label='CANCEL'
            size='medium'
            buttonType='texty'
      ...
      {state === States.Confirmed && (
        <ConfirmedModalContainer>
          <Lottie options={checkAnimationOptions} height={152} width={152} />
          <ConfirmedMessage weight={700}>Transaction confirmed!</ConfirmedMessage>
          <ConfirmedData>
