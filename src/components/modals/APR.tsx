        ...
        <APRModalContainer>
          ...
          <DescContainer>
            <AlertRow alignItems='flex-end'>
              <Image width={24} height={24} src='/images/alert.svg' alt='alert' />
              <SublineBold>IMPORTANT</SublineBold>
            </AlertRow>
            <Desc>
              A percentage of the GIV you earn from staking is claimable immediately, and the
              remaining percent goes into increasing your GIVstream flowrate. Over time, a greater
              percentage of your total earnings will be claimable immediately following the
            ...
            <Desc>Claimable immediately: {tokenDistroHelper.GlobalReleasePercentage}%</Desc>
            <Desc>
              Increasing your GIVstream: {100 - tokenDistroHelper.GlobalReleasePercentage}%
            </Desc>
            <Whatis>
              <a
