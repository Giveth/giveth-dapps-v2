...
import { ISelectObj } from '@/components/modals/deactivateCause/DeactivateCauseIndex';
...
const WhyContentCause = ({
	...
	<>
		<Lead>Please let us know why you are deactivating this cause!</Lead>
		<Select
			options={options}
...
export default WhyContentCause;
