  ...
  return (
    <Modal showModal={showModal} setShowModal={setShowModal}>
      <UnStakeModalContainer>
        {(stakeState === StakeState.UNKNOWN || stakeState === StakeState.CONFIRMING) && (
          <>
            <UnStakeModalTitle alignItems='center'>
              <StakingPoolImages title={title} />
              <UnStakeModalTitleText weight={700}>Unstake</UnStakeModalTitleText>
            </UnStakeModalTitle>
        ...
        {chainId && stakeState === StakeState.ERROR && (
          <ErrorInnerModal title='Something went wrong!' walletNetwork={chainId} txHash={txHash} />
        )}
      </UnStakeModalContainer>
    </Modal>
  )
