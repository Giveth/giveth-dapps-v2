...
export const WrongNetworkInnerModal: FC<IWrongNetworkInnerModal> = ({ text, targetNetworks }) => {
  ...
  return (
    <Modal showModal={showModal} setShowModal={setShowModal} hiddenClose>
      <WrongNetworkModalContainer>
        <WrongNetworkModalTitle>You&apos;re connected to the wrong network!</WrongNetworkModalTitle>
        <WrongNetworkInnerModal text={text} targetNetworks={targetNetworks} />
      </WrongNetworkModalContainer>
    </Modal>
  )
}
