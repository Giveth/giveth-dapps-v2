...
export const GIVBackExplainModal: FC<IGIVBackExplainModal> = ({ showModal, setShowModal }) => {
  return (
    <Modal showModal={showModal} setShowModal={setShowModal}>
      <GIVBackExplainContainer>
        ...
        <Desc>
          GIVbacks rewards corresponding to the current round become available after the round ends.
          If you donated to a verified project and do not yet have rewards to claim, it is likely
          that GIVbacks have not yet been distributed for that round, or that you claimed your
          GIVbacks rewards already.
        </Desc>
