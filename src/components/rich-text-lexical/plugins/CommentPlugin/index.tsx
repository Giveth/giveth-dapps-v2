...
function AddCommentBox({
	...
	return (
		<div className={styles.CommentPlugin_AddCommentBox} ref={boxRef}>
			...
			>
				<i className={`${styles.icon} ${styles['add-comment']}`} />
			</button>
		</div>
	);
}
...
function PlainTextEditor({
	...
	return (
		<LexicalComposer initialConfig={initialConfig}>
			<div
				className={styles.CommentPlugin_CommentInputBox_EditorContainer}
			>
				<PlainTextPlugin
					contentEditable={
						<ContentEditable
	...
	return (
		<li className={styles.CommentPlugin_CommentsPanel_List_Comment}>
			<div className={styles.CommentPlugin_CommentsPanel_List_Details}>
				<span
					className={
						styles.CommentPlugin_CommentsPanel_List_Comment_Author
					}
				>
					{comment.author}
				</span>
				<span
					className={
						styles.CommentPlugin_CommentsPanel_List_Comment_Time
					}
				>
					·{' '}
