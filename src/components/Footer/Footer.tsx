          ...
          <RightContainer>
            <SocialContainer>
              <a href='https://medium.com/giveth/'>
                <IconMedium size={24} color={brandColors.deep[100]} />
              </a>
              <a href='https://github.com/giveth'>
                <IconGithub size={24} color={brandColors.deep[100]} />
              </a>
              <a href='https://reddit.com/r/giveth'>
                <IconRedit size={24} color={brandColors.deep[100]} />
              </a>
              <a href='https://twitter.com/givethio'>
                <IconTwitter size={24} color={brandColors.deep[100]} />
              </a>
              <a href='https://www.youtube.com/channel/UClfutpRoY0WTVnq0oB0E0wQ'>
                <IconYoutube size={24} color={brandColors.deep[100]} />
              </a>
              <a href='https://docs.giveth.io/'>
                <IconWikipedia size={24} color={brandColors.deep[100]} />
              </a>
            </SocialContainer>
            <Row justifyContent='flex-end'>
              <Caption medium>Support us</Caption>
              <a href='https://giveth.io/donate/the-giveth-community-of-makers'>
                <CaptionRed medium>&nbsp;with your Donation</CaptionRed>
              </a>
            </Row>
            <CopyRights>MMXX - No Rights Reserved - The Giveth DAC</CopyRights>
          </RightContainer>
        </Row>
      </Container>
    </FooterContainer>
