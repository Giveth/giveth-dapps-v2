  ...
  return (
    <StreamCardContainer activeIndex={step} index={index}>
      <StreamHeader>
        ...
        <Desc>
          Welcome to the expanding GIViverse! The <b>GIVstream</b> offers continuous rewards for
          GIVeconomy participants. As the GIVeconomy grows, so does your GIV!
        </Desc>
      </StreamHeader>
      <StreamRow alignItems={'center'}>
        ...
        <StreamValueContainer alignItems={'center'}>
          <Image src='/images/icons/thunder.svg' height='56' width='32' alt='Thunder image' />
