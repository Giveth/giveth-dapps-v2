...
export const CongratulationsCard = () => {
  ...
  useEffect(() => {
    setStreamValue(formatWeiHelper(tokenDistroHelper.getStreamPartTokenPerWeek(totalAmount)))
    ...
    <CongratulationsView>
      <CongratulationsContainer>
        <CongHeader weight={700}>
          Congratulations!
          <SparkleContainer>
            <Lottie options={SparkleAnimationOptions} height={100} width={100} speed={0.8} />
          </SparkleContainer>
        </CongHeader>
        <CongContent>
          <ClaimedSubtitleA>
            <Lead>You have successfully claimed </Lead>
            <Lead>{formatWeiHelper(totalAmount.div(10))} GIV. </Lead>
            <AddGIVTokenButton provider={library} showText={false} />
            <SmileImage>
              ...
              <Image src='/images/congratulation.png' height='226' width='252' alt='union' />
            </SmileImage>
          </ClaimedSubtitleA>

          <ClaimedSubtitleB>
            Plus you&apos;re getting an additional{' '}
            <span style={{ color: '#FED670' }}>{streamValue} GIV</span> per week.
          </ClaimedSubtitleB>
        </CongContent>
        ...
        <SocialButtonsContainer>
          ...
          >
            <SocialButton>
              share on twitter
              <Image src='/images/icons/twitter.svg' height='15' width='15' alt='Twitter logo.' />
            </SocialButton>
          </a>
          <a href='https://swag.giveth.io/' target='_blank' rel='noreferrer'>
            <SocialButton>
              claim your free swag
              <Image src='/images/icons/tshirt.svg' height='15' width='15' alt='T shirt.' />
            </SocialButton>
          </a>
          <a href='https://discord.giveth.io/' target='_blank' rel='noreferrer'>
            <SocialButton>
              join our discord
              <Image src='/images/icons/discord.svg' height='15' width='15' alt='discord logo.' />
            </SocialButton>
          </a>
        </SocialButtonsContainer>
        <ExploreRow>
          ...
          <BlowingContainer>
            <Lottie options={BlowingAnimationOptions} height={100} width={80} speed={0.8} />
          </BlowingContainer>
        </ExploreRow>
        <ClaimFromAnother
          onClick={() => {
