  ...
  return (
    <InvestCardContainer activeIndex={step} index={index}>
      <StakeHeader>
        ...
        <Desc>
          Provide liquidity and get rewarded. Stake tokens in the <b>GIVfarm</b> to earn up to{' '}
        ...
        <ImpactCard>
          ...
          <div>
            <Row alignItems={'center'} justifyContent={'space-between'}>
              ...
              <MaxStakeGIV
                onClick={() => setDeposit(utils.formatEther(totalAmount.div(10)))}
              >{`Max ${utils.formatEther(totalAmount.div(10))} GIV`}</MaxStakeGIV>
            </Row>
            <ImpactCardInput>
              <InputWithUnit type='number' value={deposit} unit={'GIV'} onChange={setDeposit} />
            </ImpactCardInput>
          </div>
        </ImpactCard>
        <PoolCardContainer>
