...
export const formatEthHelper = (
  ...
  if (!amount) return '0'
  let amt: BigNumber = amount instanceof BigNumber ? amount : new BigNumber(amount)
...
export const formatWeiHelper = (
  ...
  if (amountWei instanceof ethers.BigNumber) amountEth = ethers.utils.formatEther(amountWei)
  else {
