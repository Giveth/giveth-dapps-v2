...
const config: EnvConfig = {
	...
	MAINNET_CONFIG: {
		...
		subgraphAddress:
			'https://api.thegraph.com/subgraphs/name/giveth/giveth-economy-second-kovan-staging',
	...
	XDAI_CONFIG: {
		...
		subgraphAddress:
			'https://api.thegraph.com/subgraphs/name/giveth/giveth-economy-second-xdai-staging',
